...
const {processHtmlContent} = require('./html-content-processor');
...
(async function main() {
  ...
  try {
    ...
    // get current versions of the APP
    const currentVersionString = ENV.APP_VERSION;

    html = processHtmlContent(html, currentVersionString);
    if (!html) {
