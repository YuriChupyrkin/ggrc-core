...
const ViewModel = canDefineMap.extend({
  ...
  updateAccessControlList(people, roleId) {
    ...
    let listWithoutRole = instance
      .access_control_list.filter((item) => {
    ...
    instance.access_control_list.replace(listWithoutRole);
  },
  ...
  getRoleList() {
    ...
    roleAssignments = loGroupBy(instance.access_control_list, 'ac_role_id');
  ...
  refreshPeopleInGroups() {
    let instance = this.instance;
    let groups = this.groups;
    let roleAssignments = loGroupBy(instance.access_control_list, 'ac_role_id');
