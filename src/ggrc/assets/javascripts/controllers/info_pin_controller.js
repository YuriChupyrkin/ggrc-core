...
can.Control('CMS.Controllers.InfoPin', {
  ...
  setInstance: function (opts, el, maximizedState) {
    ...
    if (instance.type === 'Assessment') {
      if (!this.assessmentOpened) {
        this.prepareView(opts, el, maximizedState, true);
        this.assessmentOpened = true;
      } else {
        this.element.find('assessment-info-pane')
          .viewModel().attr('instance', instance);
        this.prepareView(opts, el, maximizedState, false);
      }

      instance.dispatch('infoPaneOpend');
    } else {
      this.prepareView(opts, el, maximizedState, true);
